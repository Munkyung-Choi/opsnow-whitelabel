---
name: dev-end
description: 세션 종료 전 오늘의 작업 서사를 docs/journal/YYYY-MM-DD.md에 박제한다. 대화·git diff·Jira 업데이트를 교차하여 4섹션 초안을 작성하고, 사용자 확인을 받은 뒤 저장한다. 주간 Confluence 롤업은 다음 월요일 /dev-start 실행 시 자동 제안된다.
---
...
종료. 주간 Confluence 리포트 생성은 다음 월요일 `/dev-start` 실행 시 자동 제안된다.
