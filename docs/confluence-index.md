...
| 5.4    | Perf 평가 (배달 성과 평가 기록)                            | 299827212 |
| **6**  | **ADR (Architecture Decision Records)**                  | 308740232 |
| **7**  | **Deprecated Archive**                                   | 308740252 |

## Archive 보관 — 신규 작업 참조 금지

> ⚠️ 아래 페이지는 Deprecated/Superseded 처리되어 `6.3 Deprecated Archive` 하위로 이동. **어떤 작업에서도 이 페이지를 설계 근거로 참조하지 말 것.**
